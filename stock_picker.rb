...
def stock_picker(stock_price_list)
    ...
    stock_price_list.each_with_index do |buying_day, buying_day_index|
        stock_price_list.each_with_index do |selling_day, selling_day_index|
            ...
            if selling_day - buying_day > most_profit
                most_profit = selling_day - buying_day
